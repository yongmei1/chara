...
public class MessageRVAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case 1:
                ...
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.chatbot_message, parent, false);
    ...
    public void addChatToList(MessageModal chat){
        messageModalArrayList.add(chat);
